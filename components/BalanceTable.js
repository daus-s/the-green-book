...
function UserBalance({user}) {
    ...
    return (
        <div className="user-balance" style={isMobile?{...mobileStyles.row}:{}}>
            ...
            <div className="username" style={isMobile?{...mobileStyles.row.username}:{}}>{user.username}</div>
            {
            edit ?
                <input 
                    className="balance" 
                ...
                />
                :
                <div className="balance" onClick={()=>setEdit(prev=>!prev)} style={isMobile?{...mobileStyles.row.balance}:{}}>{user.user_balances.balance}</div>
            }
        </div>
    );
}
    ...
    return (
        <div className="balance-table admin-child" style={isMobile?{...mobileStyles.table}:{}}>
            ...
            <div className="user-balance title">
                <div className="pfp" style={isMobile?mobileStyles.row.pfp:{}}/>
                <div className="username" style={{fontWeight: 400, fontSize: 24, ...isMobile?mobileStyles.row.username:{}}}>Username</div>
                <div className="balance" style={{fontWeight: 400, fontSize: 24, ...isMobile?mobileStyles.row.balance:{}}}>Balance</div>
            </div>
            {
            loading ?
