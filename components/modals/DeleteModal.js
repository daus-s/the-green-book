    ...
    return (
        ...
        >
            <div className="modal" style={isMobile ? { height: "auto" } : {}}>
                ...
                <p>
                    Enter the bet name <span style={{ fontWeight: "bold", userSelect: "none" }}>{betName}</span> to close the bet. This will permanently close the bet and all placed bets will be
                    refunded.
                </p>
                <div className="actions" style={isMobile ? { maxWidth: "calc(100% - 20px)" } : {}}>
                    ...
                    />
                    <i className="warning" style={{ color: "var(--danger)" }}>
                        This action is not reversible.
                        <br />
                        Tread Carefully...
                    </i>
                    <div className="button-container">
                        <button className="cancel-button" onClick={cancelWrapper}>
                            Cancel
                        </button>
                        <button className="confirm-delete" type="submit">
                            <img src="/trash.png" alt="Delete" onClick={handleDelete} style={{ height: "24px", width: "24px" }} />
                        </button>
                    </div>
                </div>
            </div>
